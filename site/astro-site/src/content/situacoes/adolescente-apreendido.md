...
keywords:
  ...
  - adolescente apreendido o que fazer
  - medida socioeducativa internação
  - ato infracional adolescente
perguntas:
  - pergunta: 'Adolescente responde a processo criminal?'
    resposta: 'Não. Adolescente entre 12 e 18 anos responde por ato infracional, em procedimento próprio previsto no Estatuto da Criança e do Adolescente, com regras e prazos distintos do processo criminal de adultos.'
  - pergunta: 'Quanto tempo dura uma internação?'
    resposta: 'A internação não tem prazo determinado na sentença, mas é reavaliada a cada seis meses no máximo e não pode ultrapassar três anos, com liberação compulsória aos 21 anos. Cada caso é analisado individualmente.'
  - pergunta: 'A família pode visitar o adolescente no DEGASE?'
    resposta: 'Sim. O direito à convivência familiar é garantido pelo Estatuto da Criança e do Adolescente. As regras práticas de visitação seguem a organização de cada unidade e podem ser confirmadas pela defesa.'
---
