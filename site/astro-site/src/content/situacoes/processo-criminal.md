---
titulo: 'Defesa em processo criminal e recursos'
...
keywords:
  ...
  - resposta à acusação
  - recurso criminal apelação
  - fui denunciado o que acontece agora
perguntas:
  - pergunta: 'O que é a resposta à acusação?'
    resposta: 'É a primeira manifestação da defesa depois que a denúncia é recebida. Nela se apresentam as razões da defesa, documentos e o rol de testemunhas. É uma peça com prazo próprio e não repetível.'
  - pergunta: 'Ainda dá para mudar de advogado no meio do processo?'
    resposta: 'Sim. O réu pode constituir novo advogado a qualquer momento do processo. O novo defensor pede vista dos autos e assume o acompanhamento a partir do estado em que o processo estiver.'
  - pergunta: 'Condenação em primeira instância significa prisão imediata?'
    resposta: 'Não necessariamente. A sentença pode ser recorrida e o regime de cumprimento, bem como a possibilidade de recorrer em liberdade, dependem das circunstâncias analisadas em cada caso.'
---
