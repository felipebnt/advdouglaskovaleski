---
titulo: 'Execução penal, progressão e liberdade'
...
keywords:
  ...
  - progressão de regime pedido
  - livramento condicional requisitos
  - remição de pena por estudo e trabalho
perguntas:
  - pergunta: 'A progressão de regime acontece automaticamente quando completo o tempo?'
    resposta: 'Não. Ainda que os requisitos estejam cumpridos, a progressão depende de decisão judicial no processo de execução, o que normalmente exige pedido e acompanhamento.'
